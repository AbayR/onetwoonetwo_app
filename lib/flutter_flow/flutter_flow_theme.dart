...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7514F5);
  late Color secondary = const Color(0xFF8596F5);
  late Color tertiary = const Color(0xFFFFB493);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF6C6F71);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF8596F5);
  late Color accent2 = const Color(0xFFCAF18C);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xFFEFEEF3);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF57314);
  late Color error = const Color(0xFFEA4335);
  late Color info = const Color(0xFF1877F2);
